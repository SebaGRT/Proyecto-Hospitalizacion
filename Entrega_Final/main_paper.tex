...
profile of the territory of care. This paper represents the final integrated analysis
of a project that began with exploratory data analysis of the full GRD universe
(2019--2024) and proceeded through focused statistical testing on the C16.* subset,
culminating in the multilevel, socioeconomic, and clustering extensions reported here.
We address this gap by testing three pre-specified
